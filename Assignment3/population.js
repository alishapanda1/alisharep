...
var margin = {top: 20, right: 10, bottom: 150, left:180},
 ...
 var tip = d3.tip()
  ...
  .offset([-10, 0])
  .html(function(d) {
    return "<strong>Population:</strong> <span style='color:blue'>" + d.population + "</span>";
  });
...
------------------------------------------------------------------------------*/
d3.json("Population(descending)2013.json", function(error,data) {
    ...
    .attr({
     ...
     svg.selectAll('text')
            ...
            .attr({
                ...
                "y": function(d){ return yScale(d.population)+ 10; },
